    ...
    <div class="wrap">
            ...
            <div class="offcanvas-body">
                <div>
                    <form action="../addRoom" method="post">
                        <div class="mb-3">
                            <label for="roomNamber" class="form-label">Номер комнаты</label>
                            <input type="text" name="roomNamber" id="roomNamber" class="form-control" required placeholder="101, 205А и т.д.">
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="amenities" id="amenities" class="form-control" placeholder="Wi-Fi, кондиционер, мини-бар">
                        </div>
                        <div class="mb-3">
        ...
        <table class="table table-hover table-responsive w-100">
            ...
            <tr>
                ...
                <td class="col-2">
                    <a href="edit_room.jsp?id=<%= room.getId() %>" class="btn btn-sm btn-info">Изменить</a>
                    <a href="../deleteRoom?id=<%= room.getId() %>" class="btn btn-sm btn-danger" onclick="return confirm('Удалить менеджера?');">Удалить</a>
                </td>
            </tr>
            <%}%>
            </tbody>
